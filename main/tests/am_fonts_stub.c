...
const lv_font_t am_font_480_10 = {0};
const lv_font_t am_font_480_12 = {0};
const lv_font_t am_font_480_15 = {0};
const lv_font_t am_font_480_18 = {0};
const lv_font_t am_font_480_22 = {0};
