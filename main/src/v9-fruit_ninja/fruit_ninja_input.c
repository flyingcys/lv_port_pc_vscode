    ...
    for(i = 0; i < 3; ++i) {
        ...
        if(fruit_ninja_segment_hits_circle(segment.x1, segment.y1, segment.x2, segment.y2,
            ...
            if(i == 1U) {
                ...
                fruit_ninja_register_start_timer(lv_timer_create(fruit_ninja_state_start_running_timer_cb,
                                                                  FRUIT_NINJA_HOME_SLICE_FEEDBACK_MS,
                                                                  game));
            ...
            fruit_ninja_register_restore_timer(lv_timer_create(fruit_ninja_state_restore_home_fruit_timer_cb,
                                                               FRUIT_NINJA_HOME_SLICE_FEEDBACK_MS,
                                                               fruit));
            return;
        }
