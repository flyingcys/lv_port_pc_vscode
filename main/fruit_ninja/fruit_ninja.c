...
LV_IMG_DECLARE(fruit_bg_img)                            // 背景图片
...
static void start_game_cb(lv_event_t * e)
{
    ...
    lv_obj_add_flag(xxx, LV_OBJ_FLAG_HIDDEN);                   // 隐藏开始按钮
    lv_obj_add_flag(screen1, LV_OBJ_FLAG_CLICKABLE);            // 开始游戏后，屏幕可点击
}
