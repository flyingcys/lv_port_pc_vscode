 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --font lvgl/scripts/built_in_font/DejaVuSans.ttf -r 0x20-0x7E --symbols ÷×√²³ --size 16 --bpp 4 --format lvgl --no-compress --no-prefilter --lv-font-name desktop_font_calc_16 -o main/desktop/assets/fonts/desktop_font_calc_16.c
 ******************************************************************************/
...
#ifndef DESKTOP_FONT_CALC_16
#define DESKTOP_FONT_CALC_16 1
#endif

#if DESKTOP_FONT_CALC_16
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 4336, .adv_w = 103, .box_w = 6, .box_h = 6, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 4354, .adv_w = 103, .box_w = 6, .box_h = 6, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 4372, .adv_w = 215, .box_w = 10, .box_h = 10, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4422, .adv_w = 215, .box_w = 11, .box_h = 8, .ofs_x = 1, .ofs_y = 1},
    {.bitmap_index = 4466, .adv_w = 163, .box_w = 11, .box_h = 14, .ofs_x = 0, .ofs_y = -1}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t desktop_font_calc_16 = {
#else
lv_font_t desktop_font_calc_16 = {
#endif
