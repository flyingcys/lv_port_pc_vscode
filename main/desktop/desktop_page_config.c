...
static const topbar_page_config_t g_page_configs[DESKTOP_PAGE_COUNT] = {
    {
...
const topbar_page_config_t * desktop_get_page_config(uint32_t page_index)
{
    if(page_index >= DESKTOP_PAGE_COUNT) {
