...
int main(void)
{
    const topbar_page_config_t * lock_cfg = desktop_get_page_config(0);
    const topbar_page_config_t * home1_cfg = desktop_get_page_config(1);
    const topbar_page_config_t * home2_cfg = desktop_get_page_config(2);
    const topbar_page_config_t * fallback_cfg = desktop_get_page_config(DESKTOP_PAGE_COUNT);
    int failures = 0;
    ...
    failures += report_check(DESKTOP_PAGE_COUNT == 3, "DESKTOP_PAGE_COUNT should be 3");
    failures += report_check(DESKTOP_GRID_COLS == 5, "DESKTOP_GRID_COLS should be 5");
    failures += report_check(DESKTOP_GRID_ROWS == 2, "DESKTOP_GRID_ROWS should be 2");
    failures += report_check(DESKTOP_SLOT_COUNT == (DESKTOP_GRID_COLS * DESKTOP_GRID_ROWS),
                             "DESKTOP_SLOT_COUNT should match grid size (10)");
