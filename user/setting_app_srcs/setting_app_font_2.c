 ...
 * Size: 24 px
 * Bpp: 4
 * Opts: --bpp 4 --size 24 --no-compress --font OPlusSans3-Medium.ttf --symbols 设置关于息屏分钟 --format lvgl -o setting_app_font_2.c
 ******************************************************************************/
...
#ifndef SETTING_APP_FONT_2
#define SETTING_APP_FONT_2 1
#endif

#if SETTING_APP_FONT_2
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 506, .adv_w = 384, .box_w = 24, .box_h = 24, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 794, .adv_w = 384, .box_w = 23, .box_h = 23, .ofs_x = 1, .ofs_y = -3},
    {.bitmap_index = 1059, .adv_w = 384, .box_w = 23, .box_h = 24, .ofs_x = 0, .ofs_y = -3},
    ...
    {.bitmap_index = 1830, .adv_w = 384, .box_w = 22, .box_h = 24, .ofs_x = 0, .ofs_y = -3}
};
...
static const uint16_t unicode_list_0[] = {
    0x0, 0x2e5, 0x378, 0xdc1, 0x11e1, 0x30e0, 0x3d30, 0x4611
};
...
{
    {
        .range_start = 20110, .range_length = 17938, .glyph_id_start = 1,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t setting_app_font_2 = {
#else
lv_font_t setting_app_font_2 = {
#endif
